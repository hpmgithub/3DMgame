...
public class ChapterEntityDao extends AbstractDao<ChapterEntity, Long> {
    ...
    */
    ...
    private Query<ChapterEntity> typeEntity_ChapterEntityListQuery;
    ...
    /** Internal query to resolve the "chapterEntityList" to-many relationship of TypeEntity. */
    public List<ChapterEntity> _queryTypeEntity_ChapterEntityList(long typeId) {
        synchronized (this) {
            if (typeEntity_ChapterEntityListQuery == null) {
                QueryBuilder<ChapterEntity> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.TypeId.eq(null));
                queryBuilder.orderRaw("T.'SEND_DATE' DESC");
                typeEntity_ChapterEntityListQuery = queryBuilder.build();
            }
        }
        Query<ChapterEntity> query = typeEntity_ChapterEntityListQuery.forCurrentThread();
